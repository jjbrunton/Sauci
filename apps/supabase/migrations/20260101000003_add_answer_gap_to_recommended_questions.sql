-- Add answer gap blocking to get_recommended_questions
-- When user is over the threshold, returns empty (old apps see "All caught up!")
-- New apps call get_answer_gap_status to determine blocking reason
