-- Add partner_text column to questions table
ALTER TABLE public.questions ADD COLUMN IF NOT EXISTS partner_text TEXT;

-- Update get_recommended_questions to include partner_text
