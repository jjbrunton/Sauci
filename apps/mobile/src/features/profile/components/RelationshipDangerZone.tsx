...
/**
 * Danger zone component specifically for relationship-related actions.
 * Does NOT include delete account - that's in AccountScreen.
 */
export const RelationshipDangerZone: React.FC<RelationshipDangerZoneProps> = ({
    onResetProgress,
    ...
    return (
        <>
            ...
            >
                ...
                {/* Delete Relationship */}
                {onDeleteRelationship && (
                    <GlassCard style={StyleSheet.flatten([styles.dangerCard, onResetProgress && styles.dangerCardSpacing]) as ViewStyle}>
                        <View style={styles.dangerContent}>
                            <View style={styles.dangerInfo}>
...
export default RelationshipDangerZone;
